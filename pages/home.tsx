...
export default function home({showDetailedView, setShowDetailedView, isIncomeLoading, incomes, 
        onSubmitIncome, handleDeleteIncomes, isExpenseLoading, expenses, 
        onSubmitExpense, handleDeleteExpenses}) {
    ...
    return (
        <>
            ...
            >
            {!showDetailedView? <MdGridOn className={styles.icon}/>:<RiLayoutColumnLine className={styles.icon}/>}
            </button>
            ...
            <div className={!showDetailedView? styles.side_by_side_table: styles.stack_table}>
                ...
                <GridIncomesExpenses 
                    showButton={false} 
                    showDetails={showDetailedView} 
                    isIncomeExpenseLoading={isExpenseLoading} 
                    tableName='Despesas' 
